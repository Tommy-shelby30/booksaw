				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="right-element">
							<a href="signup.php" class="user-signup for-buy">
                                <span>Sign Up</span>
                                <i class="icon icon-user"></i>
                            </a>
							<a href="login.php" class="cart for-buy"><i class="bi bi-person"></i>
                            <span>Login</span>
                            </a>
						...
						<nav id="navbar">
							<div class="main-menu stellarnav">
								<ul class="menu-list">
									...
									<li class="menu-item"><a href="contactus.php" class="nav-link">Contact Us</a></li>
								</ul>
